...
public interface SubmissionRepository extends MongoRepository<Submission, String> {
    ...
    long countByUserIdAndCreatedAtAfter(String userId, Date createdAtAfter);
    long countByUserIdAndProblemIdAndCreatedAtAfter(String userId, String problemId, Date createdAtAfter);
